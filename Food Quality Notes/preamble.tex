...
\usepackage[dvipsnames]{xcolor} % Include xcolor package with dvipsnames option
...
\definecolor{lightblue}{RGB}{247, 247, 252}
\definecolor{lightgrey}{RGB}{247, 247, 247}
\definecolor{darkblue}{RGB}{41, 82, 163}
\definecolor{brightgreen}{RGB}{82, 163, 0}
\definecolor{TransparentRed}{rgb}{1, 0, 0} % a reddish apricot-like color
...
\titleformat{\chapter}[display]{\Huge\bfseries\fontencoding{T1}\sffamily\selectfont}{Chapter \thechapter}{0ex}{}[] % Set chapter font
...
\titleformat*{\subsubsection}{\large\bfseries\fontencoding{T1}\sffamily\selectfont}

\renewcommand{\cfttoctitlefont}{\huge\bfseries\fontencoding{T1}\sffamily\selectfont} % Set TOC title font
